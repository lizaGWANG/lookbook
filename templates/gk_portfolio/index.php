	...
	<footer class="footer">
		...
		<div class="footer__copyrights">
			...
			<?php if ($menu->getActive() == $menu->getDefault($lang->getTag())) : ?> 
				<p class="footer__copyrights_text">Free Joomla Template designed by <a href="https://www.gavick.com/">GavickPro - Theme Provider</a></p>
			<?php else : ?>
				<p class="footer__copyrights_text">Free Joomla Template by GavickPro - Theme Provider</p>
			<?php endif; ?>
